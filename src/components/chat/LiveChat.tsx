...
const BOT_RESPONSES: Record<string, string> = {
  ...
  "prices": "Our pricing varies by service. Call for a quote at 1-833-230-2933 or text us at 1-778-989-4357.",
  "reschedule": "No problem! Please call us at 1-833-230-2933 or text 1-778-989-4357 to reschedule your appointment.",
  "person": "Of course! You can reach us at:\n📞 Call: 1-833-230-2933\n💬 Text: 1-778-989-4357\n\nWe're available Sun-Sat (except Wed), 9AM-9PM.",
  "default": "Thanks for reaching out! For the fastest response, please call us at 1-833-230-2933 or text 1-778-989-4357. How can I help you today?"
};
              ...
              <CardContent className="p-0">
                ...
                <div className="px-4 pb-3 pt-1">
                  <div className="flex gap-2">
                    ...
                    <a href="sms:17789894357" className="flex-1">
                      <Button variant="outline" size="sm" className="w-full gap-2">
